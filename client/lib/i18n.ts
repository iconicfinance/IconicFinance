...
export const ar: Record<string, string> = {
  ...
  'Today': 'اليوم',
  'Previous date': 'تاريخ سابق',
  'Log for': 'تسجيل ليوم',
  'Date & time': 'التاريخ والوقت',
  'You can backdate up to 30 days ago.': 'يمكنك تسجيل تاريخ يعود حتى 30 يومًا مضت.',
  'Please select a date and time.': 'يرجى اختيار التاريخ والوقت.',
  'Please select a valid date and time.': 'يرجى اختيار تاريخ ووقت صحيحين.',
  'Date and time cannot be in the future.': 'لا يمكن أن يكون التاريخ والوقت في المستقبل.',
  'Date cannot be more than 30 days ago.': 'لا يمكن أن يكون التاريخ أقدم من 30 يومًا.',
